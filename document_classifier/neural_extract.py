...
EXTRACT_JSON_SCHEMA: dict = {
    ...
    "properties": {
        ...
        "ИНН покупателя": {"type": "string"},
        "Покупатель":      {"type": "string"},
        "Итого":           {"type": "string"},
    },
    "required": [
        "ИНН поставщика", "Поставщик", "Дата счета",
        "Номер счета", "ИНН покупателя", "Покупатель", "Итого",
    ],
...
EXTRACT_PREFIX = (
    ...
    "Если явного «Поставщик» нет — возьми организацию из блока «Продавец»/«Исполнитель»/«Получатель»/«Покупатель»/«Заказчик», "
    "где рядом указан ИНН поставщика. "
    "Не используй юридические фразы из условий оферты: «обязуется поставить», «обязуется оплатить», «в соответствии с настоящим…». "
    "Не используй адресные фрагменты вместо названия организации: «ул./улица», «дом», «корпус», «помещение», "
    "отдельные слова типа «БРАТИСЛАВСКАЯ», «ЛЕНИНСКИЙ». "
    ...
    "Покупатель: АО \"Бета Групп\" ИНН 5009876543\n"
    "Итого к оплате: 45 600,00 руб.\n"
    "Ответ: {\"ИНН поставщика\": \"7701234567\", \"Поставщик\": \"ООО \\\"Альфа Трейд\\\"\", "
    "\"Дата счета\": \"12.02.2024\", \"Номер счета\": \"47\", "
    "\"ИНН покупателя\": \"5009876543\", \"Покупатель\": \"АО \\\"Бета Групп\\\"\", \"Итого\": \"45 600,00\"}\n"
    "\n"
    "Пример 2:\n"
    "Текст: СЧЁТ № 2024-003 от 05.03.2024\n"
    "Исполнитель: ИП Иванов Сергей Николаевич, ИНН 501234567890\n"
    "Заказчик: ООО \"Гамма\", ИНН 6671234567\n"
    "Всего на сумму: 12 000 руб. 00 коп.\n"
    "Ответ: {\"ИНН поставщика\": \"501234567890\", \"Поставщик\": \"ИП Иванов Сергей Николаевич\", "
    "\"Дата счета\": \"05.03.2024\", \"Номер счета\": \"2024-003\", "
    "\"ИНН покупателя\": \"6671234567\", \"Покупатель\": \"ООО \\\"Гамма\\\"\", \"Итого\": \"12 000,00\"}\n"
    "\n"
    "Текст документа:\n"
)
