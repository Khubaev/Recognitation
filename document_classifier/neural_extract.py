...
EXTRACT_JSON_SCHEMA: dict = {
    ...
    "properties": {
        ...
        "Наименование поставщика": {"type": "string"},
        "Итого":                  {"type": "string"},
    },
    "required": [
        "Дата счета", "Номер счета", "ИНН поставщика",
        "Наименование поставщика", "Итого",
    ],
...
EXTRACT_PREFIX = (
    ...
    "\"Дата счета\", \"Номер счета\", \"ИНН поставщика\", "
    "\"Наименование поставщика\" — только название организации (ООО/АО/ИП и т.п.) из шапки документа, "
    ...
    "В «Наименование поставщика» возвращай именно юрлицо/ИП (ООО/АО/ИП/ПАО и т.п.) рядом с ИНН поставщика. "
    ...
    "\"ИНН поставщика\": \"7701234567\", \"Наименование поставщика\": \"ООО \\\"Альфа Трейд\\\"\", "
    "\"Итого\": \"45 600,00\"}\n"
    "\n"
    "Пример 2:\n"
    ...
    "\"ИНН поставщика\": \"501234567890\", \"Наименование поставщика\": \"ИП Иванов Сергей Николаевич\", "
    "\"Итого\": \"12 000,00\"}\n"
    "\n"
    "Текст документа:\n"
)
